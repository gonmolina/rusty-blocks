...
// --- CONFIGURACIÓN DE DISEÑO EDITORIAL ---
#set page(
  paper: "a4",
  margin: (top: 3cm, bottom: 3cm, left: 2.5cm, right: 2.5cm),
  header: align(right)[
    #text(size: 8pt, fill: rgb("666666"))[
      Simulación Termohidráulica en Rust | Código de Componentes
    ]
  ],
...
#show heading: it => {
  set text(font: "Liberation Sans", fill: rgb("1b365d"))
...
#place(top + left, dy: 5cm)[
  #align(center)[
    #text(size: 28pt, weight: "bold", font: "Liberation Sans", fill: rgb("1b365d"))[
    ...
    #grid(
      ...
      align(left)[
        ...
        #h(2cm) Rust (Edición 2021) \
        #h(2cm) Rendimiento Monofásico Explicito
      ],
    )
...
= Componentes de Conexión y Distribución de Flujo (Resistencias)

#include "pipe_1d.typ"
#pagebreak()

#include "cent_pump.typ"
#pagebreak()

= Componentes Volumétricos de Acumulación (Capacitancias)

#include "header.typ"
#pagebreak()

#include "open_tank.typ"
#pagebreak()

#include "closed_tank.typ"
#pagebreak()
