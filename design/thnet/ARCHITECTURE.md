...
## 10. Limitaciones Físicas y Supuestos del Modelo

Para un análisis detallado sobre las hipótesis simplificativas utilizadas en la formulación de THNet (incluyendo incompresibilidad hidráulica, caudal espacialmente uniforme y acoplamiento térmico-hidráulico desacoplado), así como su impacto específico en la precisión de los ejemplos simulados, consulte el documento:
