...
if __name__ == "__main__":
    ...
    # Plot Conveccion Natural Discreta con Headers Pequenos (0.1 m3)
    generate_svg(
        csv_path="discrete_natural_convection_small_headers_results.csv",
        output_path=os.path.join(art_dir, "discrete_convection_small_headers_plot.svg"),
        title="Conveccion Natural Discreta (Headers 0.1 m3) - Caudal y Temperaturas",
        x_col="t",
        y1_cols=["w_up_in"],
