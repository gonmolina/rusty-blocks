...
if __name__ == "__main__":
    ...
    # 1. Plot Conveccion Natural Discreta
    generate_svg(
        csv_path="discrete_natural_convection_results.csv",
        output_path=os.path.join(art_dir, "discrete_convection_plot.svg"),
        title="Conveccion Natural Discreta - Caudal y Temperaturas (Amortiguado)",
        x_col="t",
        y1_cols=["w_up_in"],
    ...
    # 2. Plot Bomba Centrifuga Discreta
    generate_svg(
        csv_path="discrete_pump_validation_results.csv",
        output_path=os.path.join(art_dir, "discrete_pump_plot.svg"),
        title="Bomba Centrifuga Discreta - Caudales y Presiones en Lazo Reservorio",
        x_col="t",
